<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra2.Master" AutoEventWireup="true" CodeBehind="Cotizar.aspx.cs" Inherits="S_Presentacion.Cotizacion.Cotizar" EnableEventValidation="false"%>
...
<asp:Panel ID="pnlPopup" runat="server" CssClass="modal-dialog" Style="display: none">
    ...
    <div class="card-body">
		...
		<div style="width: 330px; margin: 0 auto;">
			<asp:Button CssClass="btn btn-dark" ID="btnEnviar" runat="server" Text="Guardar" OnClick="btnEnviar_Click" />
    ...
    <div class="modal" id="ModalCodigos" tabindex="-1" role="dialog" aria-labelledby="ModalHardwareLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional">
                    <Triggers>
                        ...
                        <asp:AsyncPostBackTrigger ControlID="btnQuitarBusqueda" EventName="Click"></asp:AsyncPostBackTrigger>
                        <asp:AsyncPostBackTrigger ControlID="gvCodigos" EventName="PageIndexChanging"></asp:AsyncPostBackTrigger>
                    </Triggers>
                    <Triggers>
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            ...
                            <asp:GridView ID="gvCodigos" CssClass="table table-bordered" runat="server" Width="100%" DataSourceID="odsCodigos" AutoGenerateColumns="False" OnPageIndexChanging="gvCodigos_PageIndexChanging">
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
